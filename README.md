...
* Display Stash generated heatmaps for interactive scenes.
...
* `ENABLE_HEATMAP_DISPLAY`
  * Default: `true`
  * Shows funscript heatmap if available (generated by Stash), as a small bar on the preview thumbnail.
* `FORCE_HTTPS`
  * Default: `false`
